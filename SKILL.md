...
5. Never invent a venue, citation count, author, date, method, result, or conclusion. If an abstract/full text does not support a summary field, write `Insufficient information; no evidence found in the available abstract or text.` and retain the source URL.
